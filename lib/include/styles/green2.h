...
//                                                                              //
// USAGE: On init call: GuiLoadStyleGreen2();                                   //
//                                                                              //
...
#define GREEN2_STYLE_PROPS_COUNT  17

// Custom style name: green2
static const GuiStyleProp green2StyleProps[GREEN2_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x07fc88ff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, (int)0x030303ff },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, (int)0x01fc91ff },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 3, (int)0x01ff96ff },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, (int)0x005f38ff },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, (int)0x02ff67ff },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, (int)0x010101ff },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, (int)0x02ff93ff },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, (int)0x020202ff },    // DEFAULT_TEXT_COLOR_PRESSED 
    ...
    { 0, 19, (int)0x020202ff },    // DEFAULT_BACKGROUND_COLOR 
    { 0, 20, (int)0x00000018 },    // DEFAULT_TEXT_LINE_SPACING 
};

// WARNING: This style uses a custom font: "" (size: 16, spacing: 0)

#define GREEN2_STYLE_FONT_ATLAS_COMP_SIZE 2404

// Font atlas image pixels data: DEFLATE compressed
static unsigned char green2FontData[GREEN2_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xec,
...
static const Rectangle green2FontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo green2FontGlyphs[189] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: green2
static void GuiLoadStyleGreen2(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < GREEN2_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(green2StyleProps[i].controlId, green2StyleProps[i].propertyId, green2StyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int green2FontDataSize = 0;
    unsigned char *data = DecompressData(green2FontData, GREEN2_STYLE_FONT_ATLAS_COMP_SIZE, &green2FontDataSize);
    ...
    memcpy(font.recs, green2FontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, green2FontGlyphs, font.glyphCount*sizeof(GlyphInfo));
