...
//                                                                              //
// USAGE: On init call: GuiLoadStyleGreen();                                   //
//                                                                              //
...
#define GREEN_STYLE_PROPS_COUNT  17

// Custom style name: green
static const GuiStyleProp greenStyleProps[GREEN_STYLE_PROPS_COUNT] = {
    { 0, 0, (int)0x2ce071ff },    // DEFAULT_BORDER_COLOR_NORMAL 
    { 0, 1, (int)0x091e11ff },    // DEFAULT_BASE_COLOR_NORMAL 
    { 0, 2, (int)0x2ce071ff },    // DEFAULT_TEXT_COLOR_NORMAL 
    { 0, 3, (int)0x1e1400ff },    // DEFAULT_BORDER_COLOR_FOCUSED 
    { 0, 4, (int)0xe0c286ff },    // DEFAULT_BASE_COLOR_FOCUSED 
    { 0, 5, (int)0x1e1400ff },    // DEFAULT_TEXT_COLOR_FOCUSED 
    { 0, 6, (int)0x100f1eff },    // DEFAULT_BORDER_COLOR_PRESSED 
    { 0, 7, (int)0x7b70e0ff },    // DEFAULT_BASE_COLOR_PRESSED 
    { 0, 8, (int)0x100f1eff },    // DEFAULT_TEXT_COLOR_PRESSED 
    { 0, 9, (int)0xb3e0c4ff },    // DEFAULT_BORDER_COLOR_DISABLED 
    { 0, 10, (int)0x181e1aff },    // DEFAULT_BASE_COLOR_DISABLED 
    { 0, 11, (int)0xb3e0c4ff },    // DEFAULT_TEXT_COLOR_DISABLED 
    { 0, 16, (int)0x00000010 },    // DEFAULT_TEXT_SIZE 
    { 0, 17, (int)0x00000000 },    // DEFAULT_TEXT_SPACING 
    { 0, 18, (int)0x2ce071ff },    // DEFAULT_LINE_COLOR 
    { 0, 19, (int)0x091e11ff },    // DEFAULT_BACKGROUND_COLOR 
    { 0, 20, (int)0x00000018 },    // DEFAULT_TEXT_LINE_SPACING 
};

// WARNING: This style uses a custom font: "" (size: 16, spacing: 0)

#define GREEN_STYLE_FONT_ATLAS_COMP_SIZE 2404

// Font atlas image pixels data: DEFLATE compressed
static unsigned char greenFontData[GREEN_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xec,
...
static const Rectangle greenFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
static const GlyphInfo greenFontGlyphs[189] = {
    { 32, 0, 13, 4, { 0 }},
    { 33, 2, 4, 5, { 0 }},
    { 34, 2, 4, 7, { 0 }},
    { 35, 1, 4, 8, { 0 }},
...
// Style loading function: green
static void GuiLoadStyleGreen(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < GREEN_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(greenStyleProps[i].controlId, greenStyleProps[i].propertyId, greenStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int greenFontDataSize = 0;
    unsigned char *data = DecompressData(greenFontData, GREEN_STYLE_FONT_ATLAS_COMP_SIZE, &greenFontDataSize);
    ...
    memcpy(font.recs, greenFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, greenFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
